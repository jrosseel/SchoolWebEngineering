...
-- UserProfile_Address [rel1]
alter table `address`  add column  `userprofile_oid`  integer;
alter table `address`   add index fk_address_userprofile (`userprofile_oid`), add constraint fk_address_userprofile foreign key (`userprofile_oid`) references `userprofile` (`oid`);
