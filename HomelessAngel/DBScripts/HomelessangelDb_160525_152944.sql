...
alter table `address`   add index fk_address_angel (`userprofile_oid`), add constraint fk_address_angel foreign key (`userprofile_oid`) references `angel` (`userprofile_oid`);
